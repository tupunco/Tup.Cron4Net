...
public class TaskExecutor {
	 ...
	 */
	private ArrayList<TaskExecutorListener> listeners = new ArrayList<TaskExecutorListener>();
	...
	private void notifyExecutionPausing() {
		synchronized (listeners) {
			for (Iterator<TaskExecutorListener> i = listeners.iterator(); i
					.hasNext();) {
				TaskExecutorListener l = i.next();
